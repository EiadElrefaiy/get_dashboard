window.onload = function(){
    ...
    var deliveryId = localStorage.getItem("deliveryPage");
    fetch("http://app.getcenter.info/api/v1/admins/get-delivery-id", {
        method: 'POST',
        body: JSON.stringify({
            id : deliveryId,
        ...
        .then((data) => {
            console.log(data); 
            document.getElementById("state").value = data["delivery"][0]["state"];
            document.getElementById("price").value = data["delivery"][0]["price"];
    });         
  }
}
...
function editDelivery(){
    var deliveryId = localStorage.getItem("deliveryPage");
    fetch("http://app.getcenter.info/api/v1/admins/edit-delivery", {
        method: 'POST',
        body: JSON.stringify({
            id : deliveryId,
